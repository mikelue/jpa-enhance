 ...
 * Java Enumeration.<p>
 *
 * The problem in Java Enumeration is that integral value of enum
 ...
 * persited in database, the value loaded would become differential meaning in program.
 *
 * @param <T> The database constant type(Numeric)
 *
 * <pre>
 * public enum SomeStatus implements DbValueGetter<Byte> {
