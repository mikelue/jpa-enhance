...
/**
 * This class tests the skeleton of JPA operations in SpringFramework.
 */
...
public class SpringInjectedTypedDaoFacadeTest extends AbstractTestNGSpringContextTests {
    @PersistenceContext
    private EntityManager entityManager;

    @Inject
    private SpringDefaultCarDao testDao;

    private final int CAR_ID = 1;

    public SpringInjectedTypedDaoFacadeTest() {}
