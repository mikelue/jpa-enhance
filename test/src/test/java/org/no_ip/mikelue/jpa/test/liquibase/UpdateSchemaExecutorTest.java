...
public class UpdateSchemaExecutorTest {
    ...
    public void updateWithDropFirst()
    {
        ...
        LiquibaseBuilder liquibaseBuilder = LiquibaseBuilder.build(
            "org/no_ip/mikelue/jpa/test/liquibase/UpdateSchemaExecutorTest-updateWithDropFirst.xml", new ClassLoaderResourceAccessor(),
            dataSource
        );
    ...
    public void setupEnvironment(Method method)
    {
        ...
        liquibaseBuilder = LiquibaseBuilder.build(
            "org/no_ip/mikelue/jpa/test/liquibase/UpdateSchemaExecutorTest.xml", new ClassLoaderResourceAccessor(),
            dataSource
        );
